      ...
      <article className="container p-0 card my-4 shadow">
        <div className="card-body">
          ...
          <p>
            ...
            modify the URL to include our affiliate link (which means we'll get a cut of the sale if you purchase the
            item you're looking at (of course the goal of Carbon Calculator is for you to not buy the item!). This is
